(function () {
  ...
  const lessonRows = [
    ...
    ["创作", "设计一条可解路线", "规则设计、可解性、作者解、反例", "设计一关，并用自己的程序证明它能通关", "规则版本与作者解", "creator-template", "可解不是一句保证。目标、障碍和动作上限必须与一份真实运行成功的作者解同时成立。", "在小模板内选择信标、放置最多两块障碍并设置动作上限；再修复一份坏规则，用内置失败方案试玩自己的作品。", "学生会知道：规则是否可行要由测试、作者解和关联反例共同证明。", ["只保存截图", "动作上限小于作者解", "目标被规则围住"]],
