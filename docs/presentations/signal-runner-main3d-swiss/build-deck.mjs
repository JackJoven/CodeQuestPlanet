...
<section class="slide accent" data-layout="SWISS-COVER-ASCII" data-animate="hero">
  <div class="canvas-card">
    ...
    <div class="chrome-min"><div class="l">CodeQuestPlanet · Prototype Field Note</div><div class="r">CQP · 26.08.07 · 01 / 12</div></div>
    <div style="flex:1;padding:0;display:grid;grid-template-rows:auto 1fr auto;gap:2.6vh">
      ...
      <div data-anim="bottom" style="display:grid;gap:1.6vh;border-top:1px solid rgba(255,255,255,.22);padding-top:2vh">
        <div data-anim="lead" class="lead" style="max-width:58ch;color:rgba(255,255,255,.86);font-weight:400">CodeQuestPlanet 是一个可以运行的 3D 编程学习原型：学生编排指令、观察世界、读取日志，再修改程序。</div>
  ...
  <div class="canvas-card">
    ...
    <div style="flex:1;display:grid;grid-template-rows:auto 1fr;gap:4vh;min-height:0">
      ...
      <div data-anim="up" class="journey-grid">
        <figure class="journey-shot"><div class="frame-img"><img src="images/03-course-map.png" data-image-slot="s16-brief-16x10" alt="CodeQuestPlanet 课程地图"></div><figcaption class="journey-cap"><strong>01</strong><span>课程地图</span></figcaption></figure>
...
html = html.replace("<title>[必填] 替换为 PPT 标题 · Deck Title</title>", "<title>CodeQuestPlanet · 让第一段代码在 3D 世界里跑起来</title>");
