...
| 版本 | 文件 | 说明 |
|---|---|---|
| v1.8 | [知识点驱动的 32 课游戏机制](../../.scratch/core-32-learning-mechanics-v18/PRD.md) | 本轮修改规格；证据基础及第 1–32 课已通过本地技术验收，课堂学习效果待验证。 |
| v1.8 交接 | [试玩与下一步操作](../../MODEL_HANDOFF.md) | 当前试玩范围、工程接口、剩余逐课工单与可复制的实现/审查指令。 |
